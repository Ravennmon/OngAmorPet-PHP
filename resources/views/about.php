...
<body>
    ...
    <main>
        ...
        <section id="Pedro" class="init profile fade fade-right">
            ...
            <div>
                ...
                <p>Pedro tem 22 anos, cursa o 2º semestre de ADS (Analise e desenvolvimento de Sistemas) e esta se
                    aprimorando para o mercado de daos.</p>
        ...
        <section id="Francyne" class="init profile fade fade-left">
            ...
            <div>
                ...
                <p>Francyne tem 27 anos, cursa o 2º semestre de ADS (Analise e desenvolvimento de Sistemas), já tem uma
                    formação em designer gráfico.</p>
        ...
        <section id="Renan" class="profile fade fade-right">
            ...
            <div>
                ...
                <p>Renan tem 26 anos, cursa o 2º semestre de ADS (Analise e desenvolvimento de Sistemas), e já esta no
                    mercado de tecnologia a 4 anos, 3 deles como Back-End.</p>
                <a class="botao" href="https://github.com/rnnrls97" target="_blank">GitHub</a>
            </div>

        </section>

        <section id="Henrique" class="init profile fade fade-right">
    ...
    <div id="dev">
        Desenvolvido por: <a class="dev" target="_blank"> Francyne Leocadio, Renan Dos Santos, Pedro Dawybida e Henrique
            Onorato. </a>
    </div>
