...
<body>
    ...
    <main>
        ...
        <section id="inicio" class="init fade fade-right">
            ...
            <img src="resources/img/alimentos pet.svg">
            <div>
            ...
            <div>
                <img class="absolute" src="resources/img/shape roxo.svg" alt="">
            </div>

        </section>

        <section id="cachorros" class="init fade fade-left">
            <img src="resources/img/Menina e cachorro.svg" alt="Cães" width="" height="" loading="lazy">
            <div>
        ...
        <section id="gatos" class="fade fade-right">
            <img src="resources/img/menina e gato.svg" alt="Gatos" width="" height="" loading="lazy">
